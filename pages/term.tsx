  ...
  return (
    <Background>
      ...
      <p>
        <p>
          <em>
            &#34;&lt; 물 반 사람 반 &gt;&#40;&#34;https://busanbeachweather.com/&#34;이하&#34;부산해수욕장날씨&#34;&#41;
          </em>
          은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고
          원활하게처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.&#34;
        </p>
        <p>
          ○ 이 개인정보처리방침은<em>2022</em>년<em>8</em>월<em>15</em>부터 적용됩니다.
        </p>
        <br />
        <p>
          <strong>
            ...
            <br />
            <br />
            <em>&lt; 물 반 사람 반 &gt;(&#34;https://busanbeachweather.com/&#34;이하 &#34;부산해수욕장날씨&#34;)</em>
        ...
        <ul>
          ...
          <p>홈페이지 회원가입 및 관리 없음 목적으로 개인정보를 처리합니다.</p>
          <br />
          <p>2. 민원사무 처리</p>
          <p>민원사무 처리 없음 목적으로 개인정보를 처리합니다.</p>
          <br />
          <p>3. 재화 또는 서비스 제공</p>
          <p>재화 또는 서비스 제공 없음을 목적으로 개인정보를 처리합니다.</p>
          <br />
          <p>4. 마케팅 및 광고에의 활용</p>
          <p>마케팅 및 광고에의 활용 없음 등을 목적으로 개인정보를 처리합니다.</p>
          <br />
          <p>5. 개인영상정보</p>
          <p>개인영상정보 없음 등을 목적으로 개인정보를 처리합니다.</p>
          <br />
        </ul>
        <br />
        <br />
        <p>
          ...
          <br />
          <br />①<em>&lt; 물 반 사람 반 &gt;</em>은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
        ...
        <p>
          ...
          <br />
          <br /> ① <em>&lt; 물 반 사람 반 &gt;</em>은(는) 다음의 개인정보 항목을 처리하고 있습니다.
        </p>
        <br />
        <br />
        <p>
        ...
        <p>
          <br />① &lt; 물 반 사람 반 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을
          ...
          <br />
          1. 파기절차
          <br /> &lt; 물 반 사람 반 &gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt; 물 반 사람 반 &gt; 의
        ...
        <p>
          <br />
          <br />① 정보주체는 물 반 사람 반에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수
          있습니다.
        </p>
        <p>
          ② 제1항에 따른 권리 행사는물 반 사람 반에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편,
          모사전송(FAX) 등을 통하여 하실 수 있으며 물 반 사람 반은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p>
        ...
        <p>
          ⑥ 물 반 사람 반은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한
        ...
        <p>
          ...
          <br /> 개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화 하여 개인정보를 관리하는 대책을 시행하고
          있습니다.
          <br />
          <br />
        </p>
        ...
        <p>
          <br />
          <br />물 반 사람 반 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용하지 않습니다.
          <p>
            <strong>제8조 (개인정보 보호책임자에 관한 사항) </strong>
          </p>
          <p>
            {' '}
            ①<span>물 반 사람 반</span> 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한
          ...
          <ul>
            ...
            <li>직책 :개발</li>
            <li>직급 :사원</li>
            <li>연락처 :01054327510, cloudwi@naver.com, </li>
          </ul>
          <p>
            ※ 개인정보 보호 담당부서로 연결됩니다.
            <p />
            ...
            <p>
              ② 정보주체께서는 물 반 사람 반 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
              불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 물 반 사람 반
            ...
            <p>
              <strong>
                ...
                <br />
                &lt; 물 반 사람 반 &gt;은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.{' '}
              </strong>
            </p>
            <ul>
            ...
            <p>
              <strong>
                제10조(정보주체의 권익침해에 대한 구제방법)<em></em>
              </strong>
            </p>
            <br />
            <br />
            ...
            <p>
              <strong>
                제11조(개인정보 처리방침 변경)<em></em>
              </strong>
            </p>
          </p>
          <br />
          저희 업체는 개인정보를 수집하지 않습니다.
        </p>
      </p>
    </Background>
  );
